...
*/
var pessoa = { nome: 'Denis', sobrenome: 'Junior', sexo: 'Masculino', idade: 25, altura: 1.79, peso: 90, andando: false, caminhouQuantosMetros: 0 };
...
*/
pessoa.nomeCompleto(); // 'Olá, meu nome é Denis Junior'

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarIdade(); // 'Eu tenho 25 anos.'
...
retornada)
*/
pessoa.mostrarIdade(); // 'Eu tenho 28 anos!'
...
pessoa.apresentacao = function() {
 ...
 return 'Olá, eu sou ' + fem + ' ' + pessoa.nomeCompleto ', tenho ' + pessoa.idade + ' ' + ano + ', ' + pessoa.altura + ', meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros + ' ' + met + '!';
